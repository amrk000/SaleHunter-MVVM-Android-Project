...
public class UnderlayNavigationDrawer {
    ...
    public void openMenu(){
        ...
        if(menuButton!=null) {
            menuButton.setImageDrawable(activity.getResources().getDrawable(R.drawable.menu_close));
    ...
    public void closeMenu(){
        ...
        if(menuButton!=null) {
            menuButton.setImageDrawable(activity.getResources().getDrawable(R.drawable.menu_default));
